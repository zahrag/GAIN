...
from codes.supervised_train import train
...
''' 
    ...
    supervised experiments presented by GAIN paper.
...
flags.DEFINE_string('train_prefix', prefix, 'prefix identifying training data (Inductive or Transductive).')
...
flags.DEFINE_integer('samples_2', 3, 'number of samples in layer 2')
...
def save_configs(log_dir=None):
    ...
    info += 'validate_iter:{}\nvalidate_batch_size:{}\n'.format(FLAGS.validate_iter, FLAGS.validate_batch_size)
